...
* **Data-driven Decisions (데이터 기반 의사결정)**
    ...
    * 산업 데이터 활용 전략 및 [데이터 거버넌스 체계 구축](./week11.md)
* **Field-driven Innovation (현장 중심 혁신)**
    * 산업 현장 밀착형 기술 개발 및 실무 중심의 혁신 솔루션 도출
    * [사회기술시스템(STS)](./week03.md) 관점의 현장 문제 해결 연구
...
* [비즈니스 역량 및 EA(Enterprise Architecture)](./week09.md) 기반의 산학 협력 모델 구현
...
* **시스템 구축**: [데이터 기반 의사결정 시스템(DSS/BI)](./week04.md) 설계 및 현장 적용
